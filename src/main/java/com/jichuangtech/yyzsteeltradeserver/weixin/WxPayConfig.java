package com.jichuangtech.yyzsteeltradeserver.weixin;
...
public class WxPayConfig {
	...
	//支付成功后的服务器回调url
	public static final String NOTIFY_URL = "https://www.jichuangtech.site/yyzsteeltradeserver/api/pay/wxNotify";
	//签名方式，固定值
